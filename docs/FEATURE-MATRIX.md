...
| A link pasted in the advert box | A paste that is only a link is spotted and never sent to a model; a link with words beside it is read as an advert | No — not built there               | Built                     |
