...
| Data export/import                           | Yes — user-initiated file in/out; the file carries the profile and the archived documents, and Settings counts them                                                                              | Yes — plus migration to/from Light | Built                     |
...
| Candidate profile (L-154)                    | Yes — headline, languages, work rights, deal-breakers, goals, STAR examples; first view, Ctrl+1; in the backup file                                                                              | Yes — synced                       | Built                     |
| Documents archived on an application (L-155) | Yes — advert, CV, cover letter, follow-up, interview pack rows; in the backup file                                                                                                               | Yes — server-side                  | Built                     |
| Eligibility and language gates (L-156)       | Yes — pass/fail/flag before the score, quoting the advert; never averaged in                                                                                                                     | Not applicable                     | Built                     |
| Rank search results, no key (L-157)          | Yes — keyword band per result against the newest CV, deal-breaker chips from the profile                                                                                                         | Not applicable                     | Built                     |
| Skills-gap heatmap (L-158)                   | Yes — skills the board's adverts ask for that the CV lacks, on the Profile view                                                                                                                  | Not applicable                     | Built                     |
| Funnel strip (L-159)                         | Yes — sent, interviewing, offers, rates, under the tracker header                                                                                                                                | Not applicable                     | Built                     |
...
| Save as Word (L-165)                         | Yes — the tailored CV and the cover letter as a .docx built on this machine: single column, standard headings, plain fonts, no tables or images                                                  | Not applicable                     | Built                     |
